...
const MonitoringType: NextPage<MonitoringTypeType> = ({ onClose }) => {
  return (
    <div className="w-[190px] rounded bg-light-solid-color-extra-white shadow-[0px_4px_16px_rgba(165,_163,_174,_0.45)] overflow-hidden flex flex-col items-start justify-start p-2 box-border gap-[4px_0px] max-w-full max-h-full text-left text-mini font-light-basic-typography-h4-heading">
