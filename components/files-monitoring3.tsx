...
export type FilesMonitoring3Type = {
  onClose?: () => void;
};

const FilesMonitoring3: NextPage<FilesMonitoring3Type> = ({ onClose }) => {
  ...
  const [isSelectMonths2PopupOpen, setSelectMonths2PopupOpen] = useState(false);
  const iconButton4Ref = useRef<HTMLButtonElement>(null);
  const [isDaysPopupOpen, setDaysPopupOpen] = useState(false);
  const iconButton5Ref = useRef<HTMLButtonElement>(null);
  const [isEveryPopupOpen, setEveryPopupOpen] = useState(false);
  const iconButton6Ref = useRef<HTMLButtonElement>(null);
  const [isDaysPopup1Open, setDaysPopup1Open] = useState(false);
  ...
  const openSelectMonths2Popup = useCallback(() => {
    setSelectMonths2PopupOpen(true);
  }, []);

  const closeSelectMonths2Popup = useCallback(() => {
    setSelectMonths2PopupOpen(false);
  }, []);
  ...
  const openEveryPopup = useCallback(() => {
    setEveryPopupOpen(true);
  }, []);

  const closeEveryPopup = useCallback(() => {
    setEveryPopupOpen(false);
  }, []);

  const openDaysPopup1 = useCallback(() => {
    setDaysPopup1Open(true);
  }, []);

  const closeDaysPopup1 = useCallback(() => {
    setDaysPopup1Open(false);
  }, []);
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      <>
          ...
          <div className="w-full rounded-xl [filter:drop-shadow(0px_4px_4px_rgba(0,_0,_0,_0.05))] flex flex-col items-start justify-start py-3.5 px-[19px] box-border gap-[12px] max-w-[620px] text-lg text-gray-100 font-mont">
            ...
            <div className="self-stretch rounded-md bg-light-solid-color-extra-white flex flex-col items-start justify-start p-[15px] gap-[4px_0px] text-smi text-black font-light-basic-typography-h4-heading border-[1px] border-solid border-light-solid-color-extra-divider">
              ...
              <div className="w-[190px] flex flex-col items-start justify-start gap-[4px_0px] text-sm text-mont font-mont">
                <div className="self-stretch relative"> Months</div>
                <div className="self-stretch rounded-md bg-light-solid-color-extra-white flex flex-row items-center justify-start border-[1px] border-solid border-light-solid-color-extra-divider">
                  <div className="flex-1 rounded-md overflow-hidden flex flex-row items-center justify-start py-[7px] px-3.5 gap-[0px_6px]">
                    ...
                    <button
                      className="cursor-pointer [border:none] p-0 bg-[transparent] w-4 h-4 flex flex-row items-center justify-center relative gap-[0px_10px]"
                      ref={iconButton3Ref}
                      onClick={openSelectMonths2Popup}
                    >
                      <div className="w-2.5 absolute !m-[0] top-[1px] left-[-13px] text-mini leading-[22px] font-semibold font-light-basic-typography-h4-heading text-black text-left hidden z-[0]">
                        T
                      </div>
            ...
            <div className="self-stretch rounded-md h-[76px] overflow-hidden shrink-0 flex flex-col items-start justify-center py-[7px] px-2 box-border">
              <div className="self-stretch flex flex-row flex-wrap items-center justify-start gap-[6px]">
                <button className="cursor-pointer [border:none] py-[5px] px-2.5 bg-light-opacity-color-danger-danger-16 w-[75px] rounded flex flex-row items-center justify-between box-border">
            ...
            <div className="w-[190px] flex flex-col items-start justify-start gap-[4px_0px] text-sm text-mont">
            ...
            <div className="self-stretch flex flex-row items-start justify-start gap-[0px_30px] text-sm text-mont">
              <div className="relative">Jobs on</div>
              <div className="w-[190px] flex flex-col items-start justify-start gap-[4px_0px]">
                <div className="w-[400px] relative hidden">Days</div>
                <div className="self-stretch rounded-md bg-light-solid-color-extra-white flex flex-row items-center justify-start border-[1px] border-solid border-light-solid-color-extra-divider">
                  <div className="flex-1 rounded-md overflow-hidden flex flex-row items-center justify-start py-[7px] px-3.5 gap-[0px_6px]">
                    <input
                      className="[border:none] [outline:none] font-light-basic-typography-h4-heading text-smi bg-[transparent] flex-1 relative leading-[21px] text-transparent !bg-clip-text [background:linear-gradient(rgba(255,_255,_255,_0.5),_rgba(255,_255,_255,_0.5)),_#4b465c] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] text-left"
            ...
            <div className="self-stretch flex flex-col items-start justify-start">
              <div className="self-stretch rounded-md bg-light-solid-color-extra-white flex flex-row flex-wrap items-center justify-start border-[1px] border-solid border-light-solid-color-extra-divider">
                <div className="flex-1 rounded-md overflow-hidden flex flex-row flex-wrap items-center justify-start py-[7px] px-2 gap-[6px]">
                  <button className="cursor-pointer [border:none] py-[5px] px-2.5 bg-light-opacity-color-danger-danger-16 w-20 rounded flex flex-row items-center justify-between box-border">
                    <div className="relative text-smi leading-[14px] font-semibold font-light-basic-typography-h4-heading text-transparent !bg-clip-text [background:conic-gradient(from_180deg_at_50%_50%,_rgba(176,_25,_44,_0.9)_0deg,_rgba(210,_46,_67,_0.72)_309.6deg)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] text-left">
                      First
                    </div>
                    <img className="w-3.5 relative h-3.5" alt="" src="/x.svg" />
        ...
        {isSelectMonths2PopupOpen && (
          <PortalPopup
            overlayColor="rgba(113, 113, 113, 0.3)"
            placement="Bottom left"
            relativeLayerRef={iconButton3Ref}
            onOutsideClick={closeSelectMonths2Popup}
          >
            <SelectMonths onClose={closeSelectMonths2Popup} />
          </PortalPopup>
        )}
        {isDaysPopupOpen && (
          <PortalPopup
            overlayColor="rgba(113, 113, 113, 0.3)"
            placement="Bottom left"
            relativeLayerRef={iconButton4Ref}
        ...
        {isEveryPopupOpen && (
          <PortalPopup
            overlayColor="rgba(113, 113, 113, 0.3)"
            placement="Bottom left"
            relativeLayerRef={iconButton5Ref}
            onOutsideClick={closeEveryPopup}
          >
            <Every onClose={closeEveryPopup} />
          </PortalPopup>
        )}
        {isDaysPopup1Open && (
          <PortalPopup
            overlayColor="rgba(113, 113, 113, 0.3)"
            placement="Bottom left"
            relativeLayerRef={iconButton6Ref}
            onOutsideClick={closeDaysPopup1}
          >
            <Days1 onClose={closeDaysPopup1} />
          </PortalPopup>
        )}
      </>
...
export default FilesMonitoring3;
