...
const SourceSftp: NextPage = () => {
  ...
  const onTabClick = useCallback(() => {
    router.push("/source-sftp1");
  }, [router]);

  const onTab2Click = useCallback(() => {
    router.push("/target-sftp-management");
  }, [router]);

  const onBadgeContainer1Click = useCallback(() => {
    // Please sync "download files" to the project
  }, []);

  const onBadgeContainerClick = useCallback(() => {
    // Please sync "file management" to the project
  }, []);

  const onBadgeContainer2Click = useCallback(() => {
  ...
  return (
    <>
      <div className="w-full relative overflow-hidden flex flex-row items-start justify-start gap-[0px_10px] text-left text-2xs text-light-solid-color-extra-semi-dark font-light-basic-typography-h4-heading">
        ...
        <div className="flex-1 flex flex-col items-start justify-start pt-4 px-0 pb-0 gap-[8px_0px] text-mini text-colors-3text-primary">
          ...
          <div className="self-stretch flex flex-col items-start justify-start py-2.5 px-6 gap-[26px_0px]">
            ...
            <div className="self-stretch rounded-xl bg-light-solid-color-extra-white flex flex-col items-start justify-start p-6 gap-[7px_0px] text-center text-dark-solid-color-extra-body-background">
              <div className="self-stretch flex flex-col items-center justify-start pt-[38px] px-0 pb-2.5 gap-[13px_0px]">
                ...
                <div className="w-[1055px] box-border flex flex-row items-center justify-start py-2.5 px-0 border-b-[2px] border-solid border-light-solid-color-extra-divider">
                  <button
                    className="cursor-pointer [border:none] py-2 px-4 bg-[transparent] flex-1 rounded-md flex flex-row items-center justify-center"
                    onClick={onTabClick}
                  >
                    <div className="relative text-mini leading-[22px] font-light-basic-typography-h4-heading text-transparent !bg-clip-text [background:conic-gradient(from_180deg_at_50%_50%,_rgba(176,_25,_44,_0.9)_0deg,_rgba(210,_46,_67,_0.72)_309.6deg)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] text-left">{`Source SFTP `}</div>
                  </button>
                  <Button
                    className="flex-1"
                    color="error"
                  ...
                  <button
                    ...
                    onClick={onTab2Click}
                  >
                    <div className="relative text-mini leading-[22px] font-light-basic-typography-h4-heading text-transparent !bg-clip-text [background:conic-gradient(from_180deg_at_50%_50%,_rgba(176,_25,_44,_0.9)_0deg,_rgba(210,_46,_67,_0.72)_309.6deg)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] text-left">
                      Target SFTP
                    </div>
                  </button>
                </div>
                <div className="self-stretch overflow-hidden flex flex-col items-center justify-start gap-[10px_0px] text-left">
                  <div className="self-stretch bg-light-solid-color-extra-white flex flex-row flex-wrap items-start justify-start py-2 px-6 gap-[20px] text-dark-solid-color-extra-header-background border-b-[2px] border-solid border-light-solid-color-extra-divider sm:flex-col">
                    <div className="flex-1 flex flex-row items-start justify-start pt-3 px-0 pb-0 box-border min-w-[198px] sm:flex-[unset] sm:self-stretch">
                      <div className="flex-1 bg-light-solid-color-extra-white box-border h-[249px] flex flex-col items-start justify-start border-r-[1px] border-solid border-light-solid-color-extra-divider md:w-6/12 sm:w-full">
                        <div className="self-stretch flex-1 flex flex-col items-start justify-start">
                          <div className="self-stretch flex-1 flex flex-col items-start justify-start gap-[12px_0px]">
                            ...
                            <div className="self-stretch flex-1 flex flex-col items-start justify-start gap-[2px_0px]">
                              <div className="self-stretch relative leading-[22px] font-medium">
                                Port Number
                              </div>
                              <div className="self-stretch relative text-smi leading-[20px] text-transparent !bg-clip-text [background:linear-gradient(rgba(255,_255,_255,_0.2),_rgba(255,_255,_255,_0.2)),_#4b465c] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">
                    ...
                    <div className="flex-1 h-[261px] flex flex-row items-start justify-start sm:flex-[unset] sm:self-stretch">
                      <div className="flex-1 bg-light-solid-color-extra-white flex flex-col items-start justify-start md:w-6/12 sm:w-full">
                        <div className="self-stretch h-[261px] flex flex-col items-start justify-between">
                          <div className="self-stretch flex-1 flex flex-col items-start justify-start gap-[12px_0px]">
                            <div className="self-stretch rounded-md bg-light-solid-color-extra-white h-11 overflow-hidden shrink-0 flex flex-col items-center justify-start">
                              <div className="self-stretch flex flex-row items-center justify-start py-2.5 px-5 gap-[0px_16px]">
                                <div className="flex-1 relative leading-[22px]">
                                  Source SFTP Server Status
                                </div>
                                <div className="w-[81px] rounded bg-light-solid-color-success-success-500-base shadow-[0px_2px_3px_rgba(40,_199,_111,_0.3)] flex flex-row items-center justify-start py-[5px] px-2 box-border text-smi text-light-solid-color-extra-white">
                                  <div className="relative leading-[14px] font-semibold">
                                    Connected
                                  </div>
                                </div>
                              </div>
                              <div className="self-stretch relative rounded-12xs h-px" />
                              <div className="self-stretch relative rounded-12xs h-px" />
                            </div>
                            <div className="self-stretch flex flex-row items-center justify-start py-2.5 px-5 gap-[0px_16px] text-smi text-light-solid-color-extra-white">
                              <div className="flex-1 relative text-mini leading-[22px] text-dark-solid-color-extra-header-background">
                                Download Files
                              </div>
                              <div className="rounded bg-light-solid-color-success-success-500-base shadow-[0px_2px_3px_rgba(40,_199,_111,_0.3)] hidden flex-row items-center justify-start py-[5px] px-2.5">
                                <div className="relative leading-[14px] font-semibold">
                                  Configured
                                </div>
                              </div>
                              <div
                                className="rounded [background:conic-gradient(from_180deg_at_50%_50%,_rgba(176,_25,_44,_0.9)_0deg,_rgba(210,_46,_67,_0.72)_309.6deg)] shadow-[0px_2px_3px_rgba(115,_103,_240,_0.3)] flex flex-row items-center justify-start py-[5px] px-2.5 cursor-pointer"
                                onClick={onBadgeContainer1Click}
                              >
                                <div className="relative leading-[14px] font-semibold">
                                  Configure
                                </div>
                            ...
                            <div className="self-stretch flex flex-row items-center justify-start py-2.5 px-5 gap-[0px_16px]">
                              ...
                              <div
                                className="rounded [background:conic-gradient(from_180deg_at_50%_50%,_rgba(176,_25,_44,_0.9)_0deg,_rgba(210,_46,_67,_0.72)_309.6deg)] shadow-[0px_2px_3px_rgba(115,_103,_240,_0.3)] flex flex-row items-center justify-start py-[5px] px-2.5 cursor-pointer text-smi text-light-solid-color-extra-white"
                                onClick={onBadgeContainerClick}
                              >
                                <div className="relative leading-[14px] font-semibold">
                                  Configure
                                </div>
                            ...
                            <div className="self-stretch flex flex-row items-center justify-start py-2.5 px-5 gap-[0px_16px]">
                              ...
                              <div
                                className="rounded [background:conic-gradient(from_180deg_at_50%_50%,_rgba(176,_25,_44,_0.9)_0deg,_rgba(210,_46,_67,_0.72)_309.6deg)] shadow-[0px_2px_3px_rgba(115,_103,_240,_0.3)] flex flex-row items-center justify-start py-[5px] px-2.5 cursor-pointer text-smi text-light-solid-color-extra-white"
                                onClick={onBadgeContainer2Click}
                              >
                                <div className="relative leading-[14px] font-semibold">
                                  Configure
                                </div>
                  ...
                  <div className="self-stretch rounded-md bg-light-solid-color-extra-white shadow-[0px_4px_18px_rgba(75,_70,_92,_0.1)] flex flex-col items-center justify-start text-xl font-h5-heading1">
                    <div className="self-stretch flex flex-col items-center justify-start">
                      <div className="self-stretch bg-light-opacity-color-extra-menu-open flex flex-row items-center justify-center py-[12.5px] px-[18px] gap-[0px_10px] text-mini font-light-basic-typography-h4-heading">
                        <div className="flex flex-row items-center justify-start gap-[0px_6px]">
                          <div className="w-[18px] rounded [background:conic-gradient(from_180deg_at_50%_50%,_rgba(176,_25,_44,_0.9)_0deg,_rgba(210,_46,_67,_0.72)_309.6deg)] shadow-[0px_2px_4px_rgba(165,_163,_174,_0.3)] h-[18px] flex flex-row items-center justify-center p-0.5 box-border">
                            <img
                              className="w-3.5 relative h-3.5"
                      ...
                      <div className="self-stretch flex flex-row items-center justify-start text-smi font-light-basic-typography-h4-heading border-[1px] border-solid border-light-solid-color-extra-divider">
                        ...
                        <div className="w-[110px] flex flex-row items-center justify-between py-[16.5px] px-5 box-border text-center">
                          <div className="flex-1 relative tracking-[1px] uppercase font-medium text-transparent !bg-clip-text [background:linear-gradient(rgba(255,_255,_255,_0.1),_rgba(255,_255,_255,_0.1)),_#4b465c] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">
                            ACTIONS
                          </div>
                        </div>
