...
const SourceSftp1: NextPage = () => {
  ...
  const onTab1Click = useCallback(() => {
    router.push("/source-sftp");
  }, [router]);
          ...
          <div className="self-stretch flex flex-col items-start justify-start py-2.5 px-6 gap-[26px_0px]">
            ...
            <div className="self-stretch rounded-xl bg-light-solid-color-extra-white flex flex-col items-start justify-start p-6 gap-[7px_0px] text-center text-7xl text-light-solid-color-extra-semi-dark">
              <div className="self-stretch flex flex-col items-center justify-start pt-[38px] px-0 pb-2.5 gap-[13px_0px]">
                ...
                <div className="w-[1055px] flex-1 box-border flex flex-row items-center justify-start py-2.5 px-0 border-b-[2px] border-solid border-light-solid-color-extra-divider">
                  <Button
                    className="flex-1"
                    color="error"
                    variant="contained"
                ...
                <div className="self-stretch h-[459px] overflow-hidden shrink-0 flex flex-col items-center justify-start gap-[5px_0px] text-left text-smi">
                  <div className="self-stretch flex flex-row flex-wrap items-start justify-center gap-[8px]">
                    <div className="w-80 flex flex-col items-end justify-start gap-[8px_0px]">
                      ...
                      <div className="self-stretch h-10 flex flex-col items-start justify-start gap-[4px_0px] text-dimgray">
                  ...
                  <div className="self-stretch flex flex-row flex-wrap items-start justify-center gap-[8px]">
                    ...
                    <div className="w-80 flex flex-col items-end justify-start gap-[8px_0px]">
                      ...
                      <div className="self-stretch h-10 flex flex-col items-start justify-start gap-[4px_0px] text-light-solid-color-danger-danger-500-base">
                        <div className="w-[400px] hidden flex-row items-start justify-between">
                  ...
                  <div className="self-stretch flex flex-col items-center justify-center p-6 text-light-solid-color-extra-white">
                    <div className="flex flex-col items-start justify-start gap-[8px_0px]">
                      <button className="cursor-pointer p-0 bg-[transparent] rounded-md shadow-[0px_2px_4px_rgba(165,_163,_174,_0.3)] flex flex-row items-center justify-center border-[1px] border-solid border-crimson">
                        <div className="flex flex-row items-center justify-center py-2.5 px-5">
                          <div className="relative text-mini leading-[24px] font-light-basic-typography-h4-heading text-transparent !bg-clip-text [background:conic-gradient(from_180deg_at_50%_50%,_rgba(176,_25,_44,_0.9)_0deg,_rgba(210,_46,_67,_0.72)_309.6deg)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] text-left">
                            Test connection
                          </div>
                        </div>
                      </button>
                      <div className="flex flex-col items-center justify-center">
                        <div className="rounded bg-light-solid-color-success-success-500-base flex flex-row items-center justify-start py-[5px] px-2.5">
                          <div className="relative leading-[14px] font-medium">
                            Success
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-col items-center justify-center text-light-solid-color-danger-danger-500-base">
