...
const TargetSftpManagement: NextPage = () => {
            ...
            <div className="self-stretch rounded-xl bg-light-solid-color-extra-white flex flex-col items-start justify-start p-6 gap-[7px_0px] text-center text-7xl text-light-solid-color-extra-semi-dark">
              <div className="self-stretch flex flex-col items-center justify-start pt-[38px] px-0 pb-2.5 gap-[13px_0px]">
                ...
                <div className="w-[1055px] box-border flex flex-row items-center justify-start py-2.5 px-0 border-b-[2px] border-solid border-light-solid-color-extra-divider">
                  <button className="cursor-pointer [border:none] py-2 px-4 bg-[transparent] flex-1 rounded-md flex flex-row items-center justify-center">
...
export default TargetSftpManagement;
