...
const TaskOverview: NextPage = () => {
  ...
  const onButtonClick = useCallback(() => {
    // Please sync "create job" to the project
  }, []);
  ...
  return (
    <>
      <div className="w-full relative overflow-hidden flex flex-row items-start justify-start gap-[0px_10px] text-left text-2xs text-light-solid-color-extra-semi-dark font-light-basic-typography-h4-heading">
        <div
          className="self-stretch w-[279px] bg-light-solid-color-extra-white shadow-[10px_20px_70px_rgba(165,_163,_174,_0.1)] flex flex-col items-center justify-start pt-0 px-0 pb-2.5 box-border [&.animate]:animate-[0.25s_ease_0s_1_normal_forwards_slide-in-left] opacity-[0] z-[0] lg:flex lg:w-[279px] md:hidden"
          data-animate-on-scroll
        >
        ...
        <div className="w-[18px] h-[18px] hidden flex-row items-center justify-start relative z-[1]">
          <img
            className="w-3/12 absolute !m-[0] h-3/6 top-[25%] right-[37.22%] bottom-[25%] left-[37.78%] max-w-full overflow-hidden max-h-full hidden z-[0]"
            alt=""
            src="/path1.svg"
        ...
        <img
          className="w-5 absolute !m-[0] top-[19px] left-[245px] h-5 hidden z-[2]"
          alt=""
          src="/clearall.svg"
        />
        <div className="self-stretch flex-1 flex flex-col items-start justify-start pt-4 px-0 pb-0 gap-[8px_0px] z-[3] text-mini text-colors-3text-primary">
          ...
          <div className="self-stretch flex flex-col items-start justify-start py-2.5 px-6 gap-[26px_0px]">
            ...
            <div className="self-stretch rounded-md bg-light-solid-color-extra-white flex flex-col items-start justify-start py-[15px] px-0 text-lg">
              <div className="self-stretch flex flex-row items-start justify-start py-[13px] px-6">
                <div className="flex-1 relative leading-[24px] font-medium text-transparent !bg-clip-text [background:linear-gradient(rgba(255,_255,_255,_0.1),_rgba(255,_255,_255,_0.1)),_#4b465c] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">
                  Statistics
                </div>
                <div className="relative text-smi leading-[20px] text-transparent !bg-clip-text [background:linear-gradient(rgba(255,_255,_255,_0.5),_rgba(255,_255,_255,_0.5)),_#4b465c] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] text-right">
                  Updated 1 month ago
                </div>
              </div>
              <div className="self-stretch flex flex-row flex-wrap items-center justify-center pt-5 px-[57px] pb-0 gap-[28px] md:pl-8 md:pr-8 md:box-border">
                <div className="flex-1 flex flex-row items-center justify-start gap-[0px_16px] min-w-[124.75px]">
                  <div className="rounded-11xl bg-light-solid-color-extra-table-striped flex flex-row items-start justify-start p-[9px]">
                    <img
                  ...
                  <div className="flex-1 flex flex-col items-start justify-start">
                    <div className="self-stretch relative leading-[24px] font-medium text-transparent !bg-clip-text [background:linear-gradient(rgba(255,_255,_255,_0.1),_rgba(255,_255,_255,_0.1)),_#4b465c] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">
                      230
                    </div>
                ...
                <div className="flex-1 flex flex-row items-center justify-start gap-[0px_16px] min-w-[124.75px]">
                  <div className="rounded-11xl bg-light-opacity-color-primary-primary-8 flex flex-row items-start justify-start p-[9px]">
                    <img
                      className="w-6 relative h-6"
                      alt=""
                      src="/sitemap.svg"
                ...
                <div className="flex-1 flex flex-row items-center justify-start gap-[0px_16px] min-w-[124.75px]">
                  <div className="rounded-11xl bg-light-opacity-color-danger-danger-8 flex flex-row items-start justify-start p-[9px]">
                    <img
                      className="w-6 relative h-6"
                      alt=""
                      src="/sitemap.svg"
                ...
                <div className="flex-1 flex flex-row items-center justify-start gap-[0px_16px] min-w-[124.75px]">
                  <div className="rounded-11xl bg-light-opacity-color-success-success-8 flex flex-row items-start justify-start p-[9px]">
                    <img
                      className="w-6 relative h-6"
                      alt=""
                      src="/sitemap.svg"
            ...
            <div className="self-stretch rounded-xl bg-light-solid-color-extra-white flex flex-col items-start justify-start gap-[7px] text-light-solid-color-extra-white">
              <div className="self-stretch overflow-hidden flex flex-row items-start justify-end pt-3 pb-[7px] pr-[13px] pl-0 gap-[10px]">
                <div className="flex-1 flex flex-col items-start justify-center">
                  <div className="w-full rounded bg-light-solid-color-extra-white box-border flex flex-row items-center justify-center max-w-[200px] border-[1px] border-solid border-colors-4text-secondary">
                    <div className="flex-1 rounded overflow-hidden flex flex-row items-center justify-start py-[7px] px-2.5 gap-[0px_8px]">
                      <input
                        className="[border:none] [outline:none] font-light-basic-typography-h4-heading text-smi bg-[transparent] flex-1 relative leading-[21px] text-transparent !bg-clip-text [background:conic-gradient(from_180deg_at_50%_50%,_rgba(176,_25,_44,_0.9)_0deg,_rgba(210,_46,_67,_0.72)_309.6deg)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] text-left"
                        placeholder="Search"
                        type="text"
                      />
                      <img
                ...
                <button className="cursor-pointer [border:none] p-0 bg-[transparent] w-7 relative h-7">
                  ...
                  />
                  <img
                    className="absolute h-[58.21%] w-[59.64%] top-[20.71%] right-[20.36%] bottom-[21.07%] left-[20%] max-w-full overflow-hidden max-h-full"
                    alt=""
                    src="/path.svg"
                  />
                </button>
                <button className="cursor-pointer [border:none] p-0 bg-[transparent] w-7 relative h-7">
                  ...
                  />
                  <img
                    className="absolute h-[48.21%] w-[63.21%] top-[37.5%] right-[18.57%] bottom-[14.29%] left-[18.21%] max-w-full overflow-hidden max-h-full"
                    alt=""
                    src="/path.svg"
                  />
                  <img
                    className="absolute h-[4.29%] w-3/12 top-[10.36%] right-[37.5%] bottom-[85.36%] left-[37.5%] max-w-full overflow-hidden max-h-full"
                    alt=""
                    src="/path8.svg"
                  />
                  <img
                    className="absolute h-[4.29%] w-3/12 top-[22.86%] right-[37.5%] bottom-[72.86%] left-[37.5%] max-w-full overflow-hidden max-h-full"
                    alt=""
                    src="/path9.svg"
                  />
                </button>
                <div className="rounded-md [background:conic-gradient(from_180deg_at_50%_50%,_rgba(175,_25,_44,_0.9)_0deg,_rgba(210,_46,_67,_0.72)_219.4deg)] shadow-[0px_2px_4px_rgba(165,_163,_174,_0.3)] hidden flex-row items-center justify-center">
                ...
                <button
                  className="cursor-pointer [border:none] p-0 bg-[transparent] w-[120px] rounded [background:conic-gradient(from_180deg_at_50%_50%,_rgba(176,_25,_44,_0.9)_0deg,_rgba(210,_46,_67,_0.72)_309.6deg)] shadow-[0px_2px_4px_rgba(165,_163,_174,_0.3)] flex flex-row items-center justify-center md:w-[120px]"
                  onClick={onButtonClick}
                >
                  <div className="flex flex-row items-center justify-center py-1.5 px-3.5 gap-[0px_6px]">
                    <img className="w-4 relative h-4" alt="" src="/plus1.svg" />
                    <div className="relative text-smi tracking-[0.43px] leading-[16px] font-medium font-light-basic-typography-h4-heading text-light-solid-color-extra-white text-left">
                      New Job
                    </div>
                  </div>
                </button>
              </div>
              <div className="self-stretch bg-light-solid-color-extra-white shadow-[0px_0px_14px_rgba(53,_64,_82,_0.05)] flex flex-col items-center justify-start min-w-[420px] text-sm text-colors-3text-primary">
                <div className="self-stretch flex flex-row items-center justify-center gap-[0px_26px] text-mid font-h5-heading1 sm:pr-6 sm:box-border sm:max-w-[420px]">
                  <div className="flex-1 rounded-t rounded-b-none bg-light-solid-color-extra-white overflow-hidden flex flex-row items-start justify-start py-4 px-0">
                    <div className="w-[329px] relative tracking-[0.06px] leading-[20.4px] font-semibold inline-block shrink-0">
                      Latest projects
                    </div>
                  </div>
                  <button className="cursor-pointer [border:none] p-0 bg-light-solid-color-extra-white w-[19.3px] h-[19.3px] flex flex-col items-start justify-start">
                    <div className="flex flex-row items-start justify-start py-[3px] px-2">
                      <img
                        className="w-[3.3px] relative h-[13.3px]"
                        alt=""
                        src="/shape-3.svg"
                      />
                    </div>
                ...
                <div className="self-stretch bg-light-opacity-color-gray-gray-8 flex flex-row items-center justify-start p-2.5 font-h5-heading1 border-b-[1px] border-solid border-gray-400">
                  <div className="flex-1 flex flex-row items-start justify-start">
                    <div className="flex-1 relative tracking-[0.07px] leading-[21.98px] font-semibold">{`Task `}</div>
                  </div>
                  <div className="flex-1 flex flex-row items-start justify-start">
                  ...
                  <div className="flex-1 flex flex-col items-start justify-start">
                    <div className="self-stretch relative tracking-[0.07px] leading-[21.98px] font-semibold inline-block h-[22px] shrink-0">
                      Last run
                    </div>
                  </div>
                  <div className="flex-1 flex flex-row items-start justify-start">
                ...
                <div className="self-stretch flex flex-row items-center justify-start py-0 px-2.5">
                  <div className="flex-1 flex flex-col items-start justify-start text-base">
                    <div className="self-stretch relative [text-decoration:underline] leading-[24px] text-transparent !bg-clip-text [background:conic-gradient(from_180deg_at_50%_50%,_rgba(176,_25,_44,_0.9)_0deg,_rgba(210,_46,_67,_0.72)_309.6deg)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">
                      Job name
                    </div>
                  ...
                  <div className="flex-1 flex flex-row items-start justify-start font-h5-heading1">
                    <div className="flex-1 relative tracking-[0.1px] leading-[20px]">
                      10 Mar 2022
                    </div>
                  </div>
                  <div className="flex-1 flex flex-row items-start justify-start text-dark-solid-color-extra-body-background">
                  ...
                  <div className="flex-1 flex flex-col items-start justify-start text-dark-solid-color-extra-header-background">
                  ...
                  <div className="flex-1 flex flex-row items-start justify-start text-smi text-light-solid-color-success-success-500-base">
                    <div className="flex flex-col items-center justify-center">
                      <div className="rounded bg-light-opacity-color-success-success-16 flex flex-row items-center justify-start py-[5px] px-2.5">
                ...
                <div className="self-stretch flex flex-row items-center justify-start py-0 px-2.5">
                  ...
                  <div className="flex-1 flex flex-row items-start justify-start text-smi text-light-solid-color-primary-primary-500-base">
                    <div className="flex flex-col items-center justify-center">
                      <div className="rounded bg-light-opacity-color-primary-primary-16 h-6 flex flex-row items-center justify-start py-[5px] px-2.5 box-border">
                        <div className="relative leading-[14px] font-medium">
                          Scheduled
                        </div>
                      </div>
                ...
                <div className="self-stretch flex flex-row items-center justify-start py-0 px-2.5">
                  ...
                  <div className="flex-1 flex flex-row items-start justify-start text-smi text-light-solid-color-danger-danger-500-base">
                    <div className="flex flex-col items-center justify-center">
                      <div className="rounded bg-light-opacity-color-danger-danger-16 flex flex-row items-center justify-start py-[5px] px-2.5">
                        <div className="relative leading-[14px] font-medium">
                          Failed
                        </div>
                      </div>
              ...
              <div className="self-stretch overflow-hidden flex flex-row items-start justify-end py-0 px-[26px] box-border min-w-[308px]">
                <div className="flex flex-row items-start justify-start gap-[0px_2px]">
                  <button className="cursor-pointer [border:none] py-1.5 px-2 bg-light-opacity-color-gray-gray-8 self-stretch rounded flex flex-row items-center justify-center">
                    <div className="relative text-smi tracking-[0.43px] leading-[16px] font-medium font-light-basic-typography-h4-heading text-transparent !bg-clip-text [background:linear-gradient(rgba(255,_255,_255,_0.2),_rgba(255,_255,_255,_0.2)),_#4b465c] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] text-left">
                      Previous
                    </div>
                  </button>
                  <button className="cursor-pointer [border:none] py-1.5 px-2 bg-[transparent] self-stretch w-7 rounded [background:conic-gradient(from_180deg_at_50%_50%,_rgba(176,_25,_44,_0.9)_0deg,_rgba(210,_46,_67,_0.72)_309.6deg)] shadow-[0px_2px_4px_rgba(165,_163,_174,_0.3)] flex flex-row items-center justify-center box-border">
                    <div className="relative text-smi tracking-[0.43px] leading-[16px] font-medium font-light-basic-typography-h4-heading text-light-solid-color-extra-white text-left">
                      1
                    </div>
                  </button>
                  <button className="cursor-pointer [border:none] py-1.5 px-2 bg-light-opacity-color-gray-gray-8 self-stretch w-7 rounded flex flex-row items-center justify-center box-border">
                    <div className="relative text-smi tracking-[0.43px] leading-[16px] font-medium font-light-basic-typography-h4-heading text-transparent !bg-clip-text [background:linear-gradient(rgba(255,_255,_255,_0.2),_rgba(255,_255,_255,_0.2)),_#4b465c] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] text-left">
                      2
                    </div>
                  </button>
                  <button className="cursor-pointer [border:none] py-1.5 px-2 bg-light-opacity-color-gray-gray-16 self-stretch w-7 rounded flex flex-row items-center justify-center box-border">
                    <div className="relative text-smi tracking-[0.43px] leading-[16px] font-medium font-light-basic-typography-h4-heading text-transparent !bg-clip-text [background:linear-gradient(rgba(255,_255,_255,_0.1),_rgba(255,_255,_255,_0.1)),_#4b465c] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] text-left">
                      3
                    </div>
                  </button>
                  <button className="cursor-pointer [border:none] py-1.5 px-2 bg-light-opacity-color-gray-gray-8 self-stretch w-7 rounded flex flex-row items-center justify-center box-border">
                  ...
                  <button className="cursor-pointer [border:none] py-1.5 px-2 bg-light-opacity-color-gray-gray-8 self-stretch w-7 rounded flex flex-row items-center justify-center box-border">
                    <div className="relative text-smi tracking-[0.43px] leading-[16px] font-medium font-light-basic-typography-h4-heading text-transparent !bg-clip-text [background:linear-gradient(rgba(255,_255,_255,_0.5),_rgba(255,_255,_255,_0.5)),_#4b465c] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] text-left">
                      5
                    </div>
                  </button>
                  <button className="cursor-pointer [border:none] py-1.5 px-2 bg-light-opacity-color-gray-gray-8 self-stretch rounded flex flex-row items-center justify-center">
