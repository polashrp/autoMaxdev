          ...
          <div className="w-[450px] flex flex-row items-center justify-center">
            <div className="flex-1 rounded-md bg-light-solid-color-extra-white shadow-[0px_4px_18px_rgba(75,_70,_92,_0.1)] flex flex-col items-center justify-start p-8 gap-[24px_0px] z-[0]">
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[26px_0px] text-smi">
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[16px_0px] text-light-solid-color-danger-danger-500-base">
                  <div className="self-stretch flex flex-col items-start justify-start gap-[4px_0px]">
                    <div className="self-stretch relative text-transparent !bg-clip-text [background:conic-gradient(from_180deg_at_50%_50%,_rgba(176,_25,_44,_0.9)_0deg,_rgba(210,_46,_67,_0.72)_309.6deg)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">
                      Email or Username
                    </div>
                  ...
                  <div className="self-stretch h-[102px] flex flex-col items-start justify-start gap-[4px_0px]">
                    <div className="self-stretch flex flex-row items-start justify-between">
                      <button className="cursor-pointer [border:none] p-0 bg-[transparent] flex-1 relative text-smi font-light-basic-typography-h4-heading text-left inline-block">
                        <ul className="m-0 font-inherit text-inherit pl-[17px]">
                          ...
                          <li className="mb-0">
                            <span className="text-tomato">Try again!</span>
                          </li>
                        </ul>
                        <p className="m-0 text-tomato">&nbsp;</p>
                        <p className="m-0">
                          <span className="text-tomato">{`Password                                                                       `}</span>
                          <span className="text-light-solid-color-extra-semi-dark">{` `}</span>
                          <span className="text-tomato">Forgot Password?</span>
                        </p>
                      </button>
                      <div className="w-[109px] relative text-transparent !bg-clip-text [background:conic-gradient(from_180deg_at_50%_50%,_rgba(176,_25,_44,_0.9)_0deg,_rgba(210,_46,_67,_0.72)_309.6deg)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] hidden">
                        Forgot Password?
                      </div>
                    </div>
                    <div className="self-stretch rounded-md bg-light-solid-color-extra-white flex flex-row items-center justify-start border-[1px] border-solid border-light-solid-color-extra-semi-dark">
